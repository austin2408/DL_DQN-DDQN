...
class ActorNet(nn.Module):
    ...
    def forward(self, x):
        ...
        action_value = torch.tanh(self.out(x))
...
class DDPG:
    ...
    def _update_behavior_network(self, gamma):
        ...
        actor_loss = (-1.0)*critic_net(state, action).mean()
        # optimize actor
        actor_net.zero_grad()
        critic_net.zero_grad()
        actor_loss.backward()
...
def main():
    ...
    parser.add_argument('-m', '--model', default='/home/austin/nctu_hw/DL/DL_hw6/ddpg.pth')
